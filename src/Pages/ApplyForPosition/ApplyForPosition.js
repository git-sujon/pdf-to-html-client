    ...
    <div>
          ...
          <form onSubmit={handleSubmit(formHandler)} className="space-y-4">
            ...
            <div>
              <div className="flex text-gray-600">
                <h4 className="asterisk  font-medium">Select Your Skill</h4>{" "}
            ...
            <div className="mt-20">
              <button
                type="submit"
                className="md:w-1/2 block text-center mx-auto border border-red-400 bg-red-400 text-sm font-medium text-white hover:text-black  px-5 py-3 transition-colors hover:bg-transparent focus:outline-none focus:ring "
              >
                Preview
              </button>
            </div>
      ...
      <div
        className={`${
          open
            ? " hidden "
            : "fixed  z-50 inset-0  bg-gray-900 bg-opacity-60 h-full   "
        }  `}
      >
